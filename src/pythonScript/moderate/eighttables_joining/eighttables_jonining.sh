...
# 定义每次提交的参数
DRIVER_MEMORY=("4G" "4G" "4G" "5G" "5G")
EXECUTOR_MEMORY=("6G" "8G" "10G" "12G" "14G")
EXECUTOR_CORES=(1 2 3 4 5)
NUM_EXECUTORS=(2 3 4 4 5)

# Spark应用程序的主类和jar包路径
MAIN_CLASS="class org.apache.spark.eighttables_joining"
APP_JAR="/root/test/moderate/eighttables_joining/joined_dataframe.py"
