...
# 创建SparkSession
spark = SparkSession.builder.appName("8Tables_joined_Dataframe").getOrCreate()
...
def joined_dataframe(df1, df2, df3, df4, df5, df6,df7,df8):
...
df_final = joined_dataframe(df_uneven,df_even,df_even2,df_even3,df_even4,df_uneven2,df_even5,df_uneven3)
df_final.show()
